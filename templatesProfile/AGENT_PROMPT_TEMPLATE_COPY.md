...
### Assignment
- Page owner: Alejandro Medina-Nunez Member D
- Page HTML: 'frontend/account/profile.html'
- Page script target: 'frontend/js/pages/account/profile.js'
- Branch: ftb-profile

- Page owner: Alejandro Medina-Nunez Member D
- Page HTML: 'frontend/account/settings.html'
- Page script target: 'frontend/js/pages/account/settings.js'
- Branch: ftb-profile
